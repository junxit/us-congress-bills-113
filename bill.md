...
That, in the enrollment of the bill H.R. 3304, the Clerk of the House of Representatives shall make the following corrections:

- **(1)** Strike sections 1 and 2.
- **(2)** Redesignate sections 3, 4, 5, and 6 as sections 1, 2, 3, and 4, respectively.
- **(3)** Strike any matter following the end of the tables in title XLVII.
