...
## § 2. Reporting of certain hospital payment data
...
- **(a)** *In general* Section 1866 of the Social Security Act (42 U.S.C. 1395cc) is amended—
  - **(1)** in subsection (a)(1)—
    ...
    - **(D)** by inserting after subparagraph (X), as redesignated by subparagraph (C)(ii), the following new subparagraph:
      > - **(Y)** in the case of a subsection (d) hospital (as defined in section 1886(d)(1)(B)), to report payment data to the Secretary in accordance subsection (l).
...
## § 3. Inclusion of information on charity care furnished by hospitals in MedPAC's annual report
...
## § 4. Public availability of report on trends in levels of charity care provided by certain hospitals
