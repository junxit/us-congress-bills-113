...
## § 2. Diplomatic security program contracting
...
- **(2)** by redesignating subsections (d), (e), (f), and (g) as subsections (e), (f), (g), and (h), respectively;
...
- **(4)** in subsection (e), as redesignated by paragraph (2) of this section—
