...
This Act may be cited as the “Terrorism Risk Insurance Program Reauthorization Act of 2014”.
...
- **(2)** in section 103—
  ...
  - **(B)** in subsection (e)—
    - **(i)** in paragraph (1)—
      - **(I)** in subparagraph (A), as previously amended by section 3—
        - **(aa)** by striking “the Transition Period and each Program Year through Program Year 4 shall be equal to 90 percent, and during Program Year 5 and each Program Year thereafter” and inserting “each calendar year”;
        - **(bb)** by striking the comma after “80 percent”; and
        - **(cc)** by striking “such Transition Period or such Program Year” and inserting “such calendar year”; and
      - **(II)** in subparagraph (B), by striking “exceed” and all that follows through clause (ii) and inserting “exceed $100,000,000 with respect to such insured losses occurring in the calendar year.”;
