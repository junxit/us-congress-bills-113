...
## § 2. Minimum contents of application for certain homeland security grant funds
...
- **(a)** *In general* Paragraph (2) of section 2004(b) of the Homeland Security Act of 2002 (6 U.S.C. 605(b)) is amended by—
  ...
  - **(2)** inserting after subparagraph (A) the following new subparagraph:
    > - **(B)**
    >   - **(i)** certification that the Governor of the State has designated a Statewide Interoperability Coordinator, including identification in such certification of the individual so designated, who is shall be responsible for—
