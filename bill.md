...
## § 1. Presidential actions in response to violations of religious freedom
...
## § 2. Presidential actions in response to particularly severe violations of religious freedom
  ...
  - **(2)** in paragraph (3)—
    ...
    - **(C)** in subparagraph (A), as redesignated—
      ...
      - **(iii)** by adding at the end the following:
        > - **(iii)** the actions taken, the purposes of the actions taken, and evaluation of the effectiveness of the actions taken.
...
## § 5. Termination of presidential actions
