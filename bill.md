...
- **(a)** *Requirements for certain officials and staff*
  - **(1)** *In general* Subchapter III of chapter 57 of title 38, United States Code, is amended by inserting after section 5723 the following new section:
    ...
    >   - **(1)** The Secretary shall ensure that the Assistant Secretary for Information and Technology, as the Chief Information Officer of the Department, possesses—
...
## § 3. Security of critical network infrastructure, including domain controller, of Department of Veterans Affairs
...
## § 8. Report on compliance with information security requirements and best practices
