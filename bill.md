...
- **(a)** *In general* Section 1866(a)(1) of the Social Security Act (42 U.S.C. 1395cc(a)(1)) is amended—
  ...
  - **(4)** by inserting after such subparagraph (X) the following new subparagraph:
    ...
    >   - **(vi)** in the case of the written notification, is—
    >     - **(I)** signed by such individual (or person acting on the individual’s behalf) to acknowledge receipt of such notification;
    >     - **(II)** written and formatted using language that is clear and easily understandable to Medicare beneficiaries; and
    >     - **(III)** made available in different languages, as specified by the Secretary.
