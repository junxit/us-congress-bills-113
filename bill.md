  ...
  - **(1)** in paragraph (6)—
    - **(A)** in subparagraph (D)—
      ...
      - **(ii)** by adding at the end the following new clause:
        > - **(iii)** The Secretary shall implement the revisions in payment pursuant to clause (i) unless the Secretary determines that the demonstration program under subparagraph (F) demonstrated that such revisions would adversely affect access to quality hospice care by beneficiaries under this title.
