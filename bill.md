...
- **(b)** *Regular update of prescription drug pricing standard* Paragraph (6) of section 1860D–12(b) of the Social Security Act (42 U.S.C. 1395w–112(b)) is amended to read as follows:
  ...
  >   - **(A)** *In general* If the PDP sponsor of a prescription drug plan uses a standard for reimbursement (as described in subparagraph (B)) of pharmacies based on the cost of a drug, each contract entered into with such sponsor under this part with respect to the plan shall provide that the sponsor shall—
  ...
  >     - **(iii)** if the source for such a standard for reimbursement is not publicly available, disclose to the applicable pharmacies all individual drug prices to be so updated in advance of the use of such prices for the reimbursement of claims; and
...
- **(a)** *In general* Section 8902 of title 5, United States Code, is amended by adding at the end the following new subsections:
  ...
  >     - **(B)** disclose to applicable pharmacies the sources used for making any such update;
  >     - **(C)** if the source for such a standard for reimbursement is not publicly available, disclose to the applicable pharmacies all individual drug prices to be so updated in advance of the use of such prices for the reimbursement of claims; and
