...
- **(1)** is composed primarily of individual accredited investors who are interested in investing personal capital in early-stage companies;
...
- **(3)** is not connected to broker-dealers or investment advisers.
...
- **(3)** the sponsor of which—
  - **(A)** does not make investment rec­om­men­da­tions or provide investment advice to event attendees;
  - **(B)** does not engage in an active role in any investment negotiations between the issuer and investors attending the event; and
