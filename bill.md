...
- **(c)** *Effective date* The amendments made by this section shall apply to expenditures paid or incurred in taxable years beginning after December 31, 2013.

## § 3. Investment tax credit for biomass heating property

- **(a)** *In general* Subparagraph (A) of section 48(a)(3) is amended by striking “or” at the end of clause (vi), by inserting “or” at the end of clause (vii), and by inserting after clause (vii) the following new clause:
...
- **(b)** *30 percent and 15 percent credits*
  - **(1)** *In general* Subparagraph (A) of section 48(a)(2) is amended—
    - **(A)** by redesignating clause (ii) as clause (iii),
    - **(B)** by inserting after clause (i) the following new clause:
      > - **(ii)** except as provided in clause (i)(V), 15 percent in the case of energy property described in paragraph (3)(A)(viii), and

    - **(C)** by inserting “or (ii)” after “clause (i)” in clause (iii), as so redesignated.
