...
- **(a)** *Cybersecurity occupation classifications*
  ...
  - **(2)** *Applicability* The Secretary of Homeland Security shall ensure that the comprehensive occupation classifications issued under subsection (a) may be used throughout the Department of Homeland Security and are made available to other Federal agencies.
- **(b)** *Cybersecurity workforce assessment*
  ...
  - **(2)** *Contents* The assessment required under paragraph (1) shall, at a minimum, include the following:
    ...
    - **(B)** Information on which cybersecurity positions are—
      - **(i)** performed by—
        - **(I)** permanent full time departmental employees;
...
- **(c)** *Workforce strategy*
  ...
  - **(2)** *Contents* The comprehensive workforce strategy developed under paragraph (1) shall include—
    ...
    - **(B)** a 10-year projection of Federal workforce needs.
