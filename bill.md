...
- **(b)** *Additional requirements*
  - **(1)** *Printed communication* Any printed communication described in subsection (a)(1) shall—
  ...
  - **(2)** *Radio, television, and internet communication*
    ...
    - **(B)** *Video communication* Any video communication described in subsection (a)(2) shall include a statement with the information referred to under that subsection—
    ...
    - **(C)** *E-mail communication* Any e-mail communication described in subsection (a)(2) shall include the information required under that subsection, displayed in a manner that—
...
## § 4. Judicial review and enforceability
