...
- **(d)** *Acquisition* The Secretary of Agriculture is authorized to acquire only by donation or exchange non-Federal lands within the boundary described in subsection (a).
- **(e)** *Public motorized use* Nothing in this Act opens privately-owned lands within the boundary described in subsection (a) to public motorized use.
