...
- **(b)** *Rulemaking*
  ...
  - **(2)** *Timing of rulemaking*
    - **(A)** If this Act is enacted before June 1, 2014, the determination under paragraph (1) shall be made by not later than the end of the 9-month period beginning on the date of the enactment of this Act.
...
- **(c)** *Unlocking at direction of owner*
  - **(1)** *In general* Circumvention of a technological measure that restricts wireless telephone handsets or other wireless devices from connecting to a wireless telecommunications network—
    - **(A)**
      - **(i)** as authorized by paragraph (3) of section 201.40(b) of title 37, Code of Federal Regulations, as made effective by subsection (a), and
