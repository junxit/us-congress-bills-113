...
- **(1)** by striking subsection (a) and inserting the following:
  ...
  >   - **(4)** *Subsequent fiscal years* The Secretary may amend or set energy performance requirements for Federal buildings for each of fiscal years 2018 through 2025 by a rule that—
  ...
  >     - **(C)** considers any energy- and water-saving measures identified in evaluations conducted under subsection (f)(3).
...
- **(2)** in subsection (f)—
  ...
  - **(C)** by striking paragraphs (3) and (4) and inserting the following:
    ...
    >     - **(v)**
    >       - **(I)** based on the benchmarking, has achieved at a facility level the most recent cumulative energy savings target under subsection (a) compared to the earlier of—
...
- **(b)** *Federal Building Efficiency Standards* Section 305 of the Energy Conservation and Production Act (42 U.S.C. 6834) is amended—
  - **(1)** in subsection (a)(3)—
    - **(A)** strike “(3)(A) Not later than” and all that follows through subparagraph (B):
    ...
    - **(B)** in subparagraph (C), by striking “(C) In the budget request” and inserting the following:
      > - **(B)** *Budget request* In the budget request

    - **(C)** in subparagraph (D)—
      - **(i)** by striking clause “(D) Not later than” and all that follows through the first sentence of subclause (III) and insert the following:
        > - **(C)** *Certification for green buildings*
        >   - **(i)** *In general*

      - **(ii)** by striking clause (ii);
      - **(iii)** in clause (iii), by striking “(iii) In identifying” and insert the following:
