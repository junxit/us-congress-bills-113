...
## § 2. Board of Veterans' Appeals video hearings
...
- **(1)** in subsection (d), by amending paragraph (1) to read as follows:
  ...
  >   - **(B)** The Board shall notify the appellant of the determinations of the location and type of hearing made under subparagraph (A). Upon notification, the appellant may request a different location or type of hearing as described in such subparagraph. If so requested, the Board may grant such request and, in doing so, shall ensure that the hearing is scheduled at the earliest possible date without any undue delay or other prejudice to the appellant.
