...
## § 2. Notice required before revocation of tax-exempt status for failure to file return

- **(a)** *In general* Section 6033(j) of the Internal Revenue Code of 1986 is amended by redesignating paragraphs (2) and (3) as paragraphs (3) and (4), respectively, and by inserting after paragraph (1) the following new paragraph:
...
- **(b)** *Reinstatement without application* Paragraph (3) of section 6033(j) of such Code, as redesignated under subsection (a), is amended—
  - **(1)** by striking “Any organization” and inserting the following:
...
- **(c)** *Effective date* The amendments made by this section shall apply to notices and returns required to be filed after December 31, 2014.
