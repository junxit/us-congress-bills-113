...
- **(1)** by redesignating paragraphs (4) through (16) as paragraphs (5) through (17), respectively;
...
- **(3)** in paragraph (12)(B), as so redesignated—
  - **(A)** by striking “(B) does not include a risk retention group” and inserting the following:
    > - **(B)** does not include—
