...
- **(1)** in section 3 (29 U.S.C. 203)—
  ...
  - **(B)** by adding at the end the following:
    ...
    >       - **(iv)** the constructing, repairing and maintaining of roads or camps used in connection with logging; the constructing, repairing, and maintenance of machinery or equipment used in logging; and
