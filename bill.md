...
- **(a)** *Requirement To identify and describe programs* On an annual basis, for purposes of the report required by subsection (b), the head of each agency shall—
  ...
  - **(2)** for each such program—
    - **(A)** determine the total administrative costs of the program;
...
- **(c)** *Database required* The Director shall maintain a database of information—
  - **(1)** used to create the report required by subsection (a); and
  - **(2)** obtained through meeting the requirements of section 21 of the Statutory Pay-As-You-Go Act of 2010 (31 U.S.C. 712 note).

## § 4. Government Accountability Office requirements relating to identification, consolidation, and elimination of duplicative Government programs
...
- **(4)** *Performance indicator, performance goal, output measure* The terms performance indicator, performance goal, and output measure have the meanings provided those terms by section 1115 of title 31, United States Code.
...
## § 7. Regulations and implementation
...
- **(b)** *Implementation* This Act shall be implemented not later than one year after the date of the enactment of this Act.
