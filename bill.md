...
- **(c)** *Smithsonian institution*
  - **(1)** *In general* Following the award of the gold medal in honor of the American Fighter Aces, the gold medal shall be given to the Smithsonian Institution, where it will be available for display as appropriate and available for research.
